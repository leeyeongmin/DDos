						...
						<div class="influence-profile-content pills-regular">
							<ul class="nav nav-pills mb-3 nav-justified" id="pills-tab"
								...
								<li class="nav-item"><a class="nav-link active"
									...
									aria-controls="pills-campaign" aria-selected="true">Campaign</a>
								</li>
								...
								<li class="nav-item"><a class="nav-link" id="sendMessage"
									data-toggle="pill" href="#pills-msg" role="tab"
							...
							<div class="tab-content" id="pills-tabContent">
											...
											<div class="row">
												<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
													<div
														...
														<div class="mr-4">
															<img src="assets/images/slack.png" alt="User Avatar"
														...
														<div class="media-body ">
															<div class="influencer-profile-data">
																...
																<p>
																	<span class="m-r-20 d-inline-block">Draft Due
																		Date <span class="m-l-10 text-primary">24 Jan
																			2018</span>
																	</span> <span class="m-r-20 d-inline-block"> Publish
																		Date <span class="m-l-10 text-secondary">30 Feb
																			2018</span>
																	</span> <span class="m-r-20 d-inline-block">Ends <span
												...
												<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
													<div
														...
														<div class="media-body">
															...
															<p>
																<span class="m-r-20 d-inline-block">Draft Due
																	Date<span class="m-l-10 d-inline-block text-primary">28
																		Jan 2018</span>
																</span><span class="m-r-20 d-inline-block"> Publish Date<span
																	class="m-l-10 text-secondary">20 March 2018</span></span><span
																	class="m-r-20">Ends<span
												...
												<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
													<div
														...
														<div class="media-body">
															...
															<p>
																<span class="m-r-20 d-inline-block">Draft Due
																	Date <span class="m-l-10 text-primary">05 Feb
																		2018</span>
																</span> <span class="m-r-20 d-inline-block"> Publish
																	Date <span class="m-l-10 text-secondary">14 May
																		2018</span>
																</span><span class="m-r-20 d-inline-block">Ends<span
																	class="m-l-10 text-info">16 Aug, 2018</span></span>
															</p>
														</div>
													</div>
												</div>
								...
								<div class="tab-pane fade show active" id="messageForm"
									role="tabpanel" aria-labelledby="pills-campaign-tab"></div>
