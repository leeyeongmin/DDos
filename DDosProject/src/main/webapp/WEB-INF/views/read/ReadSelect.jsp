                     ...
                     buttons : {
                        "연장" : function() {
                           $
                                 .ajax({
                                    type : "post",
                                    url : "extension?loginId=${login.id}&selectSeat="
                                          + localStorage
                                                .getItem('seating'),
                                    success : function() {
                                       dialog.dialog("close");
                                       room_show(localStorage
                                             .getItem("room"));
                                    }
                                 })
                        },
                        "반납" : function() {
                           $.ajax({
                              type : "post",
                              url : "return_seat?loginId=${login.id}"
                                    + "&selectSeat="
                                    + localStorage
                                          .getItem('seating'),
                              success : function() {
                     ...
                     buttons : {
                        "반납" : function() {
                           $
                                 .ajax({
                                    type : "post",
                                    url : "return_seat?loginId=${login.id}&selectSeat="
                                          + localStorage
                                                .getItem('seating'),
                                    success : function() {
                                       localStorage
                        ...
                        for (var i = 0; i < result.length; i++) {
                           if (row == result[i].row
                              ...
                              if (result[i].status == '1') {
                                 ...
                                 add += "<td><input type=button style=width:35px;heigt:35px;visibility:hidden;disabled=disabled></td>";
                              }
               ...
               .ajax({
                  ...
                  success : function(result) {
                     if (result.status == "2") {
                        ...
                        localStorage.setItem("seating", $(choose).attr(
                              "name"));
            ...
            <div class="row">
               <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                  <div class="page-header">
                     <h3 class="mb-2">Reading Room</h3>
                     <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                           <ol class="breadcrumb">
                              <li class="breadcrumb-item"><a href="userHome"
                                 class="breadcrumb-link">DDos</a></li>
                              <li class="breadcrumb-item active" aria-current="page">Reading
                                 Room</li>
                           </ol>
                        </nav>
                     </div>
                  ...
                  <div class="influence-profile-content pills-regular">
                     <ul class="nav nav-pills mb-3 nav-justified" id="pills-tab"
                        ...
                        <li class="nav-item"><a class="nav-link" id="A"
                           data-toggle="pill" href="#room" onclick="room_ck('A')"
                           role="tab" aria-controls="pills-campaign" aria-selected="false">A열람실</a></li>

                        <li class="nav-item"><a class="nav-link" id="B"
                           data-toggle="pill" href="#room" onclick="room_ck('B')"
                           role="tab" aria-controls="pills-packages" aria-selected="false">B열람실</a></li>
...
<div id="timer" style="font-size: 30pt;" align="center"></div> 
