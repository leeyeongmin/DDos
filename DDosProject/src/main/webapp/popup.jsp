...
<body>
	...
	<div style="top: 30%; height: 250px; overflow: scroll; " align="left" >
		...
		<h4>3. 스터디룸 개설 후 취소할 시 아웃카운트가 적용되며 3번 취소가 되면 위약금을 내야합니다.</h4>
		<h4>4. 스터디룸에서 인원미달시 자동으로 스터디가 해체 됩니다.</h4>
		<h4>5. 책 연체시 하루 당 1000원이 부과됩니다.</h4>
		<h4>6. 도서관은 9:00 ~ 21:00 이용이 가능합니다.</h4>
		<h4>7. 열람실은 3시간 동안 사용가능하며 연장은 30분 남았을 때 부터 가능합니다.</h4>
	</div>
